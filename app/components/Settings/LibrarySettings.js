...
export default class LauncherSettings extends Component<Props> {
  ...
  getTableColumns = () => {
    return [
    {title: 'Folder Path', key: 'file_path', dataIndex: 'title', width: '40%', className: "py-2  game-title", render: (val, row) => <span className="ml-2" style={{fontSize: 16}}>{row.file_path}</span>},
